...
class GameInfo:
    def __init__(self):
        self.TitleId: str = "1603BA"  # Playfab Title Id
        self.SecretKey: str = "K497O9KPFCYE79U68TFJ5IT836X8JS47MY3BQDDAZWOEKEOJRE"  # Playfab Secret Key
        self.ApiKey: str = "OC|1173159735882379|8f3d5b2ac2b2f9e698d967b68929773d"  # App Api Key (Oculus/Graph API)
